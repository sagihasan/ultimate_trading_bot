...
# רשימת מניות (126 מניות מעודכנות)
STOCK_LIST = [
    ...
    "EA", "NVIDIA", "INTUIT", "ABNB", "LYFT", "WBD", "WMT", "COST", "TGT", "LOW",
    "HD", "SBUX", "MCD", "PEP", "KO", "JNJ", "MRK", "PFE", "CVX", "XOM",
    "APA", "AR", "FANG", "OXY", "SLB", "HAL", "WFC", "BAC", "C", "JPM",
    "GS", "MS", "BX", "SCHW", "V", "MA", "AXP", "TROW", "BK", "AMP",
    "SPY", "QQQ", "DIA", "IWM", "XLK", "XLF", "XLE", "XLY", "XLV", "XLP"
]
